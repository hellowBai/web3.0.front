...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.PlatON]: '0x4c650FB471fe4e0f476fD3437C3411B1122c4e3B',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.PlatON]: '0xB048Bbc1Ee6b733FFfCFb9e9CeF7375518e25997',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.PlatON]: TICK_LENS_MAINNET_ADDRESS,
} as const satisfies Record<ChainId, Address>
